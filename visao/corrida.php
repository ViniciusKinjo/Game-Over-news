    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4" style="margin-bottom: 10px;">
            <div class="card" style="width: 20rem; height: 30rem;">
              <img class="card-img-top" src="img/GTCup.png" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">Gran Turismo</h5>
                <p class="card-text">Foram abertas as incrições para o GT cup! Para mais informações, acesse o site oficial do Gran TUrismo!<br><br>22/04/2021</p>
                <a href="https://www.gran-turismo.com/br/news/00_5142068.html" class="btn btn-secondary">Visitar</a>
              </div>
            </div>
          </div>
          <div class="col-sm-4" style="margin-bottom: 10px;">
            <div class="card" style="width: 20rem; height: 30rem;">
              <img class="card-img-top" src="img/forza7.png" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">Forza Motorsport 7</h5>
                <p class="card-text">Forza Motorsport 7 agora está disponível no Xbox Game Pass! Acesse o site para saber mais.<br><br>08/10/2020</p>
                <a href="https://www.microsoft.com/en-us/p/Forza-Motorsport-7-Standard-Edition/9N3NK5WW05HT?activetab=pivot:overviewtab" class="btn btn-secondary">Visitar</a>
              </div>
            </div>
          </div>
          <div class="col-sm-4" style="margin-bottom: 10px;">
            <div class="card" style="width: 20rem; height: 30rem;">
              <img class="card-img-top" src="img/nfs.jpg" alt="Imagem de capa do card">
              <div class="card-body">
                <h5 class="card-title">Need for Speed Heat</h5>
                <p class="card-text">Lançou Need for Speed Heat! O mais novo da franquia Need for Speed! Quer saber mais sobre o jogo? Acesse o site oficial e confira!<br><br>08/11/2019</p>
                <a href="https://www.ea.com/pt-br/games/need-for-speed/need-for-speed-heat" class="btn btn-secondary">Visitar</a>
              </div>
            </div>
          </div>
        </div>
