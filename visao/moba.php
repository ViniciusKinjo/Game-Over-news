    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4" style="margin-bottom: 10px;">
              <div class="card" style="width: 20rem; height: 30rem;">
                <img class="card-img-top" src="img/smite.jpg" alt="Imagem de capa do card">
                <div class="card-body">
                  <h5 class="card-title">Smite</h5>
                  <p class="card-text">Patch 8.4 do Smite está disponível! Quer saber sobre as mudanças? Acesse o site oficial do Smite!<br><br>28/04/2021</p>
                  <a href="https://www.smitegame.com/news/8-4-bonus-update-notes-live-may-4/" class="btn btn-secondary">Visitar</a>
                </div>
              </div>
            </div>
            <div class="col-sm-4" style="margin-bottom: 10px;">
              <div class="card" style="width: 20rem; height: 30rem;">
                <img class="card-img-top" src="img/dota.jpg" alt="Imagem de capa do card">
                <div class="card-body">
                  <h5 class="card-title">Dota 2</h5>
                  <p class="card-text">Patch 7.29 do Dota 2 está disponível! Quer saber sobre as mudanças? Acesse o site oficial do Dota 2!<br><br>09/04/2021</p>
                  <a href="https://www.dota2.com/newsentry/3086629758333021154" class="btn btn-secondary">Visitar</a>
                </div>
              </div>
            </div>
            <div class="col-sm-4" style="margin-bottom: 10px;">
              <div class="card" style="width: 20rem; height: 30rem;">
                <img class="card-img-top" src="img/heros.webp" alt="Imagem de capa do card">
                <div class="card-body">
                  <h5 class="card-title">Heroes of the Storm</h5>
                  <p class="card-text">Patch de balanceamento está disponível! Quer saber sobre as mudanças? Acesse o site oficial de Heroes of the Storm e confira!<br><br>02/03/2021</p>
                  <a href="https://news.blizzard.com/pt-br/heroes-of-the-storm/23623169/notas-do-patch-de-balanceamento-de-heroes-of-the-storm-2-de-marco-de-2021" class="btn btn-secondary">Visitar</a>
                </div>
              </div>
            </div>
        </div>
